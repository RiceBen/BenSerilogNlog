    ...
    public class LogFactory
    {
        public static void InitMyLogger()
        {
            ...
            Log.Logger = new LoggerConfiguration()
                            .Enrich.WithProperty("AppId", new { Id = 1, Name = "BenBen" })
                            .WriteTo.Console(outputTemplate: "{Timestamp:HH:mm:ss} [AppId:{AppId} {Level:u3}] {Message:lj}{NewLine}{Exception}")
                            ...
                            .WriteTo.Logger(logger=>
                                logger.Enrich.WithProperty("AppId3", "Log!")
                                      .Filter
                                      .ByIncludingOnly(expr)
                                      .WriteTo.Console(outputTemplate: "{Timestamp:HH:mm:ss} [AppId:{AppId3}{AppId2}{AppId} {Level:u3}]$ {Message:lj}{NewLine}{Exception}"))
                            .CreateLogger();
        }
    }
}